...
const tools = [
  ...
  {
    phase: 'Steps 02–05',
    img: 'https://svgl.app/library/claude-ai-icon.svg',
    name: 'Claude',
    role: 'Orchestrator · Primary',
  ...
  {
    phase: 'Runtime + Eval',
    img: 'https://svgl.app/library/gemini.svg',
    name: 'Gemini 2.5',
